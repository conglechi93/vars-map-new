...
import { onGetEnrollEnterpriseMember, onGetEnterpriseList } from 'redux/actions/Enterprise';
...
const SignupSuccess = () => {
  ...
  useEffect(() => {
    if(enrollEnterprise) {
      setPhone(enrollEnterprise.enterpriseInfo.phone);
      setEnrollDate(enrollEnterprise.enrollDate);
      setCode(enrollEnterprise.code)
      setName(enrollEnterprise.enterpriseInfo.name);
    }
  }, [enrollEnterprise]);
    ...
    <div>
      ...
      <div>
        ...
        <div className='card-form'>
          ...
          <Button type='primary' htmlType='submit' className='sign-btn' onClick={SignupVIP}>
        ...
        <div className='card-form'>
          <div className='card-info'>
            <div className='profile-text-label'>Thông tin giao dịch</div>
