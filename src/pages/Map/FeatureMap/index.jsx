...
const HeaderMap = () => {
  const dispatch = useDispatch();
   ...
   console.log("🚀 ~ file: index.jsx ~ line 31 ~ HeaderMap ~ isOpen", isOpen)
  ...
  const TypeIcon = [
    {
      ...
      type: 'khuvuc',
      component: <LocationForm className='drop_tothua'/>,
    ...
    },
    {
      ...
      type: 'timtothua',
      component: <PlaceForm className='drop_tothua' setIsOpen={setIsOpen} />,
    },
    {
      id: 3,
      ...
      type: 'timgocranh',
      component: <AngularForm className='drop_tothua'/>,
    },
    {
      id: 4,
        ...
        <div className='Checkbox_all_chir'>
          ...
          <div className='buttom_header'>
            <div className='all_icon_header'>
              {TypeIcon.map((item) => {
                console.log("🚀 ~ file: index.jsx ~ line 216 ~ {TypeIcon.map ~ item.type == type", item.type === type)
                
                return (
                  <div key={item.id} className='Menu_all'>
                  <img
                    key={item.id}
                    src={item.src}
                    alt=''
                    className='icon_header'
                    onClick={()=>{setType(item.type), setIsOpen(true)}}
                  
                    />
                  {isOpen ? 
                  <div value={type} className='Menu_dropdown'>
                    {
                      item.type == type ? 
                      item.component : ''
                    }
